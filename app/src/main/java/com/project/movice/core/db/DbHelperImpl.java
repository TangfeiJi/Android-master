...
package com.project.movice.core.db;

import android.database.sqlite.SQLiteDatabase;

import com.project.movice.application.MoviceApp;
import com.project.movice.core.constant.Constants;
import com.project.movice.core.greendao.DaoMaster;
import com.project.movice.core.greendao.DaoSession;
import com.project.movice.core.greendao.HistoryData;
import com.project.movice.core.greendao.HistoryDataDao;
...
public class DbHelperImpl implements DbHelper {
    ...
    private void initGreenDao() {
        DaoMaster.DevOpenHelper devOpenHelper =
                new DaoMaster.DevOpenHelper(MoviceApp.getContext(), Constants.DB_NAME);
