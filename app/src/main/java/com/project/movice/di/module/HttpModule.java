...
import com.project.movice.core.http.interceptor.NetCacheInterceptor;
import com.project.movice.core.http.interceptor.OfflineCacheInterceptor;
...
public class HttpModule {
    ...
    OkHttpClient provideOkHttpClient(OkHttpClient.Builder builder) {
        ...
        //设置缓存
        File cacheFile = new File(MoviceApp.getContext().getCacheDir(), "cache");
