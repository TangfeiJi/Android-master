...
public class MyLoadPresenter extends BasePresenter<MyLoadContract.View>
        implements MyLoadContract.Presenter {
private Map<String,String> hm=new HashMap<>();
    ...
    @Override
    public void request030(Map<String, String> hm) {
        this.hm=hm;
        addSubscribe(mDataManager.get030(RequestBeanUtils.getRequestBean(hm))
                ...
                .subscribeWith(new BaseObserver(mView,
                    ...
                    public void onSuccess(String data) {
                        List<BeanMyLoan> list= FastJsonTools.parseArray(data,BeanMyLoan.class);
                        mView.get030(list);
                    }
                }));
